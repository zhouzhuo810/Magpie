...
public final class NetworkUtils {
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                (TelephonyManager) BaseUtil.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
            (ConnectivityManager) BaseUtil.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
        //noinspection ConstantConditions
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) BaseUtil.getApp().getSystemService(Context.WIFI_SERVICE);
        //noinspection ConstantConditions
